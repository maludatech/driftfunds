...
// Reusable HomeLayout component (same as in Home)
const HomeLayout = ({ children }: { children: React.ReactNode }) => (
  <main
    className="flex flex-col bg-background text-foreground pt-20"
    role="main"
  ...
  return (
    <HomeLayout>
      <div>
        {/* Hero Section */}
        <section
          className="relative flex min-h-[90vh] w-full items-center justify-center"
          style={{
        ...
        >
          <div className="mx-auto max-w-7xl px-4 py-12 text-center">
            <Skeleton className="h-10 w-3/4 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-4" />
            <Skeleton className="h-16 w-1/2 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-6" />
            <Skeleton className="h-6 w-2/3 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-8" />
            <div className="flex justify-center gap-4">
              <Skeleton className="h-10 w-32 rounded-lg bg-gray-200 dark:bg-gray-700" />
              <Skeleton className="w-[2px] h-10 bg-gray-200 dark:bg-gray-700 self-center" />
              <Skeleton className="h-10 w-32 rounded-lg bg-gray-200 dark:bg-gray-700" />
            </div>
          </div>
        </section>
        ...
        <section className="py-12">
          <div className="mx-auto max-w-7xl px-4">
            <Skeleton className="h-8 w-1/3 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-4" />
            <Skeleton className="h-4 w-2/3 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-8" />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <Skeleton className="h-10 w-32 rounded-lg bg-gray-200 dark:bg-gray-700 mt-4" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 bg-gray-100 dark:bg-gray-800">
          <div className="mx-auto max-w-7xl px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(3)].map((_, idx) => (
                <div key={idx} className="bg-card/80 p-6 rounded-lg shadow-lg">
                  <Skeleton className="h-6 w-1/2 rounded-md bg-gray-200 dark:bg-gray-700 mb-2" />
                  <Skeleton className="h-4 w-full rounded-md bg-gray-200 dark:bg-gray-700" />
                  <Skeleton className="h-4 w-3/4 rounded-md bg-gray-200 dark:bg-gray-700 mt-2" />
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-6">
              {[...Array(2)].map((_, idx) => (
                <div key={idx} className="flex flex-col md:flex-row gap-4">
                  <Skeleton className="h-48 w-full md:w-1/2 rounded-lg bg-gray-200 dark:bg-gray-700" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(3)].map((_, idx) => (
                <div key={idx} className="bg-card/80 p-6 rounded-lg shadow-lg">
                  <Skeleton className="h-4 w-full rounded-md bg-gray-200 dark:bg-gray-700" />
                  <Skeleton className="h-4 w-3/4 rounded-md bg-gray-200 dark:bg-gray-700 mt-2" />
                  <Skeleton className="h-6 w-1/2 rounded-md bg-gray-200 dark:bg-gray-700 mt-4" />
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-12 bg-gray-100 dark:bg-gray-800">
          <div className="mx-auto max-w-7xl px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[...Array(4)].map((_, idx) => (
                <div key={idx} className="bg-card/80 p-6 rounded-lg shadow-lg">
                  <Skeleton className="h-32 w-32 rounded-full mx-auto bg-gray-200 dark:bg-gray-700 mb-2" />
                  <Skeleton className="h-6 w-1/2 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mb-2" />
                  <Skeleton className="h-4 w-3/4 mx-auto rounded-md bg-gray-200 dark:bg-gray-700" />
                </div>
              ))}
            </div>
          </div>
        ...
        <footer className="bg-gray-900 dark:bg-gray-950 text-white py-12">
          <div className="mx-auto max-w-7xl px-4">
            ...
            <Skeleton className="h-4 w-1/2 mx-auto rounded-md bg-gray-200 dark:bg-gray-700 mt-8" />
          </div>
        </footer>
      </div>
    </HomeLayout>
