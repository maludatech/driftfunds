      ...
      <div>
        ...
        >
          <div className="mx-auto max-w-7xl px-4 py-12 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-slate-800 to-slate-400 dark:from-slate-200 dark:to-slate-600 text-transparent bg-clip-text animate-gradient mb-4">
              The Leading Cryptocurrency Investment Platform
            </h1>
            <h2 className="text-5xl sm:text-6xl font-extrabold text-primary mb-6">
              {APP_NAME}
            </h2>
            <p className="mx-auto max-w-3xl text-lg text-muted-foreground mb-8">
              {APP_NAME}: Where innovation maximizes your returns. Join us for a
              secure and prosperous financial journey.
            </p>
            <div className="flex justify-center gap-4">
              <Link
                href={user ? "/dashboard" : "/sign-up"}
                className="inline-block rounded-lg bg-primary px-6 py-3 text-base font-semibold text-white hover:opacity-90 transition"
              >
                Get Started
              </Link>
              <div className="w-[2px] h-10 bg-primary self-center"></div>
              <Link
                href="#about"
                className="inline-block rounded-lg border border-primary px-6 py-3 text-base font-semibold text-primary hover:bg-primary hover:text-white transition"
              >
                Learn More
              </Link>
            </div>
