...
interface UserDepositApprovalEmailProps {
  username: string;
  lastDeposit: number;
}

export const UserDepositApprovalEmail = ({
  username,
  lastDeposit,
}: UserDepositApprovalEmailProps) => {
  ...
  return (
    <Html>
      ...
      <Body style={main}>
        <Preview>
          Your {lastDeposit ? lastDeposit.toString() : "N/A"} USD deposit has
          been approved
        </Preview>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text>
              Your deposit of <strong>{lastDeposit} USD</strong> has been
              approved, and your dashboard has been updated.
            </Text>
            <Text style={paragraph}>
              If you did not initiate this deposit, please contact our support
              team immediately via{" "}
...
export default UserDepositApprovalEmail;
