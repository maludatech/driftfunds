...
interface AdminSupportEmailProps {
  username: string;
  fullName: string;
  email: string;
  subject: string;
...
export const AdminSupportEmail = ({
  ...
  return (
    <Html>
      ...
      <Body style={main}>
        <Preview>
          New support message from {username}: {subject}
        </Preview>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You have received a new message from <strong>{username}</strong> (
              {fullName}) with the subject: <strong>{subject}</strong>.
            </Text>
            <Text>{message}</Text>
            <Text style={paragraph}>
              Please reply to this message via the user’s email:{" "}
