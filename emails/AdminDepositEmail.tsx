...
interface AdminDepositEmailProps {
  username: string;
  email: string;
...
export const AdminDepositEmail = ({
  username,
  email,
  pendingDeposit,
  selectedCoin,
  selectedPlan,
}: AdminDepositEmailProps) => {
  ...
  return (
    <Html>
      ...
      <Body style={main}>
        <Preview>
          New {pendingDeposit ? pendingDeposit.toString() : "N/A"} USD deposit
          by {username}
        </Preview>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You have received a new deposit from <strong>{username}</strong> (
              {email}).
            </Text>
            <Text>
            ...
            <Text style={paragraph}>
              Please review and confirm this deposit to notify {username} via
              their email:{" "}
...
export default AdminDepositEmail;
