...
interface UserWithdrawalEmailProps {
  username: string;
...
export const UserWithdrawalEmail = ({
  username,
  pendingWithdrawal,
  selectedCoin,
  walletAddress,
}: UserWithdrawalEmailProps) => {
  ...
  return (
    <Html>
      ...
      <Body style={main}>
        <Preview>
          Your {pendingWithdrawal ? pendingWithdrawal.toString() : "N/A"} USD
          withdrawal pending
        </Preview>
...
export default UserWithdrawalEmail;
